...
# Random integer per Rg gruppo_log_analitics
resource "random_integer" "random3" {
  min = 1000
  max = 9999
}

# Storage Account Rg gruppo_log_analitics
resource "azurerm_storage_account" "storage_log_analitics" {
  name                     = "storageloganalitics${random_integer.random2.result}"
